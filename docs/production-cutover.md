...
当前状态：2026-09-08 已正式部署 `zealot-s3:next-4523867e`，容器 healthy，schema `20260908000000`；公开/密码安装页通过生产验收，原有 1 个应用、2 个账号、2 个渠道保留。实际回滚归档为 `backups/pre-cutover-20260907-235637/`。以下切换命令作为后续运维参考。
...
- 当前镜像：`zealot-s3:next-4523867e`，amd64，ID `sha256:c482cbc2168a39e0d4989605cb837b9ae01bf1c18b1c1b64b8c4d78af47063e5`。
...
```sh
docker image inspect zealot-s3:next-4523867e --format '{{.Id}}'
