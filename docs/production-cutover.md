...
当前状态：2026-09-08 已正式部署 `zealot-s3:next-1f8e5ea8`，容器 healthy，schema `20260908000000`；公开/密码安装页通过生产验收，原有 1 个应用、2 个账号、2 个渠道保留。实际回滚归档为 `backups/pre-cutover-20260907-235637/`。以下切换命令作为后续运维参考。
...
- 当前镜像：`zealot-s3:next-1f8e5ea8`，amd64，ID `sha256:12a873c03cdc9be282070969e6a05a67c3c4d781b1ff4798570a1777aaf2d82c`。
...
```sh
docker image inspect zealot-s3:next-1f8e5ea8 --format '{{.Id}}'
